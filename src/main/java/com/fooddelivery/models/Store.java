...
public class Store implements Serializable {
    ...
    public Store(String storeName, double latitude, double longitude, String category, double stars,
                 int noOfReviews, String storeLogoPath, ArrayList<Product> products) {
